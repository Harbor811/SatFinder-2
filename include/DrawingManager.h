...
public:
	...
	void addRect(const sf::Vector2f& size, const sf::Vector2f& pos, const sf::Color& col = { 255, 0, 0 });
	void addButton(const sf::Vector2f& pos, std::string textureFile, std::function<void()> onClick, bool isOwned = true);
	void addButton(Button* btn, bool isOwned = true);
